...
export function BenefitsSection() {
  return (
    <section id="beneficios" className="bg-primary py-20 text-primary-foreground sm:py-28">
        ...
        <RevealGroup className="mt-14 grid grid-cols-2 gap-4 sm:grid-cols-4">
          {BENEFITS.map((b) => (
            <RevealItem key={b.title}>
              <div className="flex h-full flex-col items-start gap-4 rounded-2xl border border-primary-foreground/10 bg-primary-foreground/5 p-5 transition-colors duration-300 hover:bg-primary-foreground/10">
