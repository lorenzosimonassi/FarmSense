  ...
  return (
    <div className="@container relative">
      ...
      >
        ...
        <div className="flex flex-col gap-3 border-t border-border bg-muted/40 p-3 @sm:p-4 @md:p-5">
          ...
          <div className="grid gap-2 @lg:grid-cols-3">
            ...
            <AlertPill
              icon={Sprout}
              text="3 animais abaixo do ganho esperado"
            />
          </div>
        </div>
      </motion.div>
      ...
      <motion.div
        ...
        className="absolute -left-6 -bottom-11 hidden items-center gap-3 rounded-xl border border-border bg-card px-4 py-3 shadow-xl sm:flex"
      >
...
function AlertPill({ icon: Icon, text }: { icon: typeof Bell; text: string }) {
  return (
